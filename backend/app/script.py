...
img: NDArray = ski.io.imread("img/ebbot_portrait.jpg")
...
(result_cluser_colors, result_user_colors) = process_img(
    rgb_img=img,
    rgb_colors=ebbot_rgb_colors,
    format_str="a3",
    min_mm_width=1.5,
    target_ppi=300,
...
ski.io.imsave("out/a3_segmented_cluster_colors.png", ski.util.img_as_ubyte(result_cluser_colors))
ski.io.imsave("out/a3_segmented_user_colors.png", ski.util.img_as_ubyte(result_user_colors))